      ...
      if (data && data.length > 0) {
        try {
          await autoAssignFirstPhaseAndTasks({
            projectId: data[0].id,
            phaseAssigneeId: projectManager, // Use project manager as the phase assignee
            taskAssigneeId: taskAssignee || projectManager, // If no task assignee is specified, use project manager
          });
        } catch (err: unknown) {
