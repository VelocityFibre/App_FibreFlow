  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-[#f0f5f9] dark:bg-[#00406a] p-6 rounded-lg shadow-sm border border-[#e0eaf3] dark:border-[#00527b]">
          <h3 className="text-lg font-medium text-[#003049] dark:text-white mb-2">Project overview, stats, and quick links</h3>
          <p className="text-gray-700 dark:text-gray-200 text-sm mb-4">Get a comprehensive view of your projects at a glance.</p>
        </div>
        
        {/* Visualization Card */}
        <div className="bg-[#f0f5f9] dark:bg-[#00406a] p-6 rounded-lg shadow-sm border border-[#e0eaf3] dark:border-[#00527b]">
          <h3 className="text-lg font-medium text-[#003049] dark:text-white mb-2">Visualize and manage project tasks</h3>
          <p className="text-gray-700 dark:text-gray-200 text-sm mb-4">Interactive dashboards to monitor progress and performance.</p>
        </div>
        
        {/* Timeline Card */}
        <div className="bg-[#f0f5f9] dark:bg-[#00406a] p-6 rounded-lg shadow-sm border border-[#e0eaf3] dark:border-[#00527b]">
          <h3 className="text-lg font-medium text-[#003049] dark:text-white mb-2">Timeline view for project planning</h3>
          <p className="text-gray-700 dark:text-gray-200 text-sm mb-4">Schedule and track project milestones with ease.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-[#f0f5f9] dark:bg-[#00406a] p-6 rounded-lg shadow-sm border border-[#e0eaf3] dark:border-[#00527b]">
          ...
          <p className="text-gray-700 dark:text-gray-200 text-sm mb-4">Organize and analyze project data efficiently.</p>
        </div>
        
        {/* Materials Card */}
        <div className="bg-[#f0f5f9] dark:bg-[#00406a] p-6 rounded-lg shadow-sm border border-[#e0eaf3] dark:border-[#00527b]">
          <h3 className="text-lg font-medium text-[#003049] dark:text-white mb-2">Track site materials and stock</h3>
          <p className="text-gray-700 dark:text-gray-200 text-sm mb-4">Manage inventory and material allocation across projects.</p>
        </div>
        
        {/* User Management Card */}
        <div className="bg-[#f0f5f9] dark:bg-[#00406a] p-6 rounded-lg shadow-sm border border-[#e0eaf3] dark:border-[#00527b]">
          <h3 className="text-lg font-medium text-[#003049] dark:text-white mb-2">User login, registration, and roles</h3>
          <p className="text-gray-700 dark:text-gray-200 text-sm mb-4">Control access and permissions for team members.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
        ...
        <div className="p-6 border border-[#e0eaf3] dark:border-[#00527b] rounded-lg bg-[#f0f5f9] dark:bg-[#00406a] shadow-sm">
          ...
          {recentProjects.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-6 text-center">
              <p className="text-gray-700 dark:text-gray-200">No recent projects found</p>
              ...
              {recentProjects.map((proj) => (
                <div key={proj.id} className="py-3 flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-xs text-gray-700 dark:text-gray-300">{proj.created_at?.slice(0, 10)}</p>
                  </div>
        ...
        <div className="p-6 border border-[#e0eaf3] dark:border-[#00527b] rounded-lg bg-[#f0f5f9] dark:bg-[#00406a] shadow-sm">
          ...
          {recentStockMovements.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-6 text-center">
              <p className="text-gray-700 dark:text-gray-200">No materials tracking data found</p>
              ...
              {recentStockMovements.map((move) => (
                <div key={move.id} className="py-3 flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-xs text-gray-700 dark:text-gray-300">{move.created_at?.slice(0, 10)}</p>
                  </div>
                  <span className="text-xs px-2 py-1 rounded-md bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200">
      ...
      <p className="text-sm text-gray-700 dark:text-gray-300 mt-8 text-center">
