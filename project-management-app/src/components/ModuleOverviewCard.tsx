...
export default function ModuleOverviewCard({
  ...
  return (
    <Link href={actionLink} className="block">
      <div className={`bg-[#f0f5f9] dark:bg-[#00406a] rounded-lg shadow-sm border border-[#e0eaf3] dark:border-[#00527b] hover:shadow-md transition-all cursor-pointer ${className}`}>
        <div className="p-6">
          ...
          <span className="inline-flex items-center justify-center px-4 py-2 bg-[#003049] text-white text-sm font-medium rounded-md hover:bg-[#00406a] transition-colors">
            {actionLabel}
          </span>
        </div>
      </div>
